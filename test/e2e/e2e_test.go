...
func init() {
	...
	// TODO(chewong): use ghcr.io/azure/azure-workload-identity/msal-go:latest instead
	...
	flag.StringVar(&azwi, "e2e.azwi", filepath.Join("..", "..", "bin", "azwi"), "The path to the azwi CLI")
