FROM --platform=$BUILDPLATFORM mcr.microsoft.com/oss/go/microsoft/golang:1.27.0-bookworm@sha256:f838b12585e4c1bc65ca5f7cafee8ee278e4c466fbdc73aa86e4eb5450c1bf14 as builder
